...
GLuint ModuleTextures::Load(const char *file, ILinfo *imageInfo) {
	GLuint texture;
	ILenum error;
	...
	if (ilLoadImage((const wchar_t*)file)) {
		iluGetImageInfo(imageInfo);
		imageInfo->Type = ilDetermineType((const wchar_t*)file);
...
GLuint ModuleTextures::Load(const char *file, ILinfo *imageInfo, GLuint wrap, bool filterNearest, bool useMipMaps) {
	GLuint texture;
	ILenum error;
